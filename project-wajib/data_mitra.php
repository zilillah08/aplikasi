                ...
                <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title"> Table Data Mitra</h2>
                            </div>                          
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table primary-table-bordered">
                                        ...
                                        include 'config.php';
                                        $no=1;
                                        $query = mysqli_query($koneksi, "SELECT * FROM data_mitra");
                                        ...
                                        ?>                             
                                            <tr>
                                                ...
                                                <td>
                                                <a href="data_mitra.php?id_mitra=<?php echo $data['id_mitra']; ?>"><button class="btn btn-primary btn-bloc"><i class=" fa fa-thin fa-trash"></i></button>
                                                </td>

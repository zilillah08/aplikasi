...
if (isset($_GET['pesan'])) {
  $id_pegawai = $_GET['id_peserta'];
  mysqli_query($koneksi, "DELETE FROM peserta WHERE id_peserta='$id_peserta'");
  header("Location:data_peserta.php?aksi=hapusok");
}
 ?>
                ...
                <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title"> Table Data Peserta</h2>
                            </div>                          
                            <div class="card-body">
                                    ...
                                    <table class="table primary-table-bordered">
                                        ...
                                        ?>                             
                                            <tr>
                                                ...
                                                <td>
                                                <a href="data_peserta.php?id_peserta=<?php echo $data['id_peserta']; ?>"><button class="btn btn-primary btn-bloc"><i class=" fa fa-thin fa-trash"></i></button>
                                                </td>

                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-icon d-inline-block">
                                    <i class="fa-solid fa-hands-praying text-success border-success"></i>
                                </div>
                                <div class="stat-content d-inline-block">
                                    <div class="stat-text">Workshop</div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-icon d-inline-block">
                                    <i class="fa fa-credit-card text-primary border-primary"></i>
                                </div>
                                <div class="stat-content d-inline-block">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-icon d-inline-block">
                                    <i class="fa fa-certificate text-yellpw border-yellow"></i>
                                </div>
                                <div class="stat-content d-inline-block">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-one card-body">
                                <div class="stat-icon d-inline-block">
                                    <i class="fa-solid fa-star text-danger border-danger"></i>
                                </div>
                                <div class="stat-content d-inline-block">

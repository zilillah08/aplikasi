...
try {
    ...
    $mail->Body = 'To reset your password click <a href="http://localhost/wmk/project-wajib/change_password.php?email=' . ($email) . '">here</a>. </br>Reset your password in a day.';
    ...
    $verifyQuery = $conn->query("SELECT * FROM userr WHERE email = '$email'");

    if ($verifyQuery->num_rows) {
        $codeQuery = $conn->query("UPDATE userr SET code = '$code' WHERE email = '$email'");
